            ...
            <div class="movie_top">
                <div class="col-md-9 movie_box">
                    ...
                    <div class="desc1 span_3_of_2">
                        <p class="movie_option"><strong>片名: </strong>　{{ $movie->name }}</p>
                        <p class="movie_option"><strong>国家: </strong>　{{ $movie->place }}</p>
                        <p class="movie_option"><strong>年份: </strong>　{{ $movie->year? $movie->year: '2001' }}</p>
                    ...
                    <div class="single">
                        ...
                        <ul class="single_list">
                            <li>
                                <div class="preview"><a href="#"><img src="/moban/images/2.jpg" class="img-responsive" alt=""></a></div>
                                <div class="data">
                            ...
                            <li>
                                <div class="preview"><a href="#"><img src="/moban/images/3.jpg" class="img-responsive" alt=""></a></div>
                                <div class="data">
                            ...
                            <li>
                                <div class="preview"><a href="#"><img src="/moban/images/4.jpg" class="img-responsive" alt=""></a></div>
                                <div class="data">
                            ...
                            <li class="middle">
                                <div class="preview"><a href="#"><img src="/moban/images/5.jpg" class="img-responsive" alt=""></a></div>
                            ...
                            <li class="last-comment">
                                <div class="preview"><a href="#"><img src="/moban/images/6.jpg" class="img-responsive" alt=""></a></div>
                                <div class="data-last">
                                    <div class="title">mr.dev  /  2 hours ago  /  <a href="#">reply</a></div>
                            ...
                            <li>
                                <div class="preview"><a href="#"><img src="/moban/images/7.jpg" class="img-responsive" alt=""></a></div>
                                <div class="data">
